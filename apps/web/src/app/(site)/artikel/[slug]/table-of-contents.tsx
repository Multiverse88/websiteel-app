...
export default function TableOfContents({ headings }: TableOfContentsProps) {
  ...
  return (
    <div className="bg-[#FAFAFA] shadow-md border border-black/[0.04] rounded-2xl p-5 shadow-[0_1px_3px_rgba(0,0,0,0.01)]">
      <div className="flex items-center gap-2 mb-4 text-[16px] font-black uppercase text-gray-400 tracking-wider">
        <svg
        ...
        {headings.map((heading) => {
          ...
          return (
            <a
              ...
              className={`transition-all duration-200 text-[16px] py-1.5 px-3 rounded-lg flex items-center leading-snug border-l-2 ${
