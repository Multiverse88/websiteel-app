...
const locationsData = [
  {
    ...
    whatsappLink: getWhatsAppLink("Halo EasyOffice Bandung, saya ingin tanya mengenai Virtual Office.", "vo-tanya-bandung", "/layanan/virtual-office"),
  },
  {
    id: "bekasi",
    ...
    whatsappLink: getWhatsAppLink("Halo EasyOffice Bekasi, saya ingin tanya mengenai Virtual Office.", "vo-tanya-bekasi", "/layanan/virtual-office"),
  },
  {
    id: "jakarta",
    ...
    whatsappLink: getWhatsAppLink("Halo EasyOffice Jakarta, saya ingin tanya mengenai Virtual Office.", "vo-tanya-jakarta", "/layanan/virtual-office"),
  },
];
  ...
  const pricingPackages: PricingPackage[] = [
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan EasyOffice Jakarta.", "vo-tertarik-jakarta", "/layanan/virtual-office"),
      groups: [
        {
    ...
    },
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan EasyOffice Bandung.", "vo-tertarik-bandung", "/layanan/virtual-office"),
      groups: [
        {
          title: "ALAMAT LENGKAP",
          items: [
    ...
    },
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan EasyOffice Bekasi.", "vo-tertarik-bekasi", "/layanan/virtual-office"),
      groups: [
        {
          title: "ALAMAT LENGKAP",
          items: [
        ...
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
            <div className="lg:w-[50%] text-left">
              ...
              >
                <a
                  href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai Virtual Office.", "vo-konsultasi", "/layanan/virtual-office")}
                  target="_blank"
