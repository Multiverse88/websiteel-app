          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <a
                  href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai layanan Kontrak Bisnis.", "ingin-konsultasi-mengenai-layanan-kontrak-bisnis", "/layanan/kontrak-bisnis")}
                  target="_blank"
      ...
      <section className="bg-white py-8 sm:py-8 sm:py-20">
        <div className="max-w-[1140px] mx-auto px-6 sm:px-8 flex flex-col md:flex-row items-center justify-between gap-12 text-left">
          ...
          <div className="w-full md:w-auto flex flex-col gap-3.5 min-w-[320px] sm:min-w-[360px] max-w-[400px]">
            {/* WhatsApp Action */}
            <a
              href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai layanan Perjanjian Perkawinan.", "ingin-konsultasi-mengenai-layanan-perjanjian-perkawinan", "/layanan/kontrak-bisnis")}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi dengan tim spesialis hukum perjanjian.", "ingin-konsultasi-dengan-tim-spesialis-hukum-perjanjian", "/layanan/kontrak-bisnis")}
              target="_blank"
              rel="noopener noreferrer"
