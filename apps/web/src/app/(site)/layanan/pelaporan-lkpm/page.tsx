...
const lkpmBenefits = [
  {
    ...
    desc: "Laporan disusun & disubmit ke OSS RBA dalam 1-3 hari kerja sejak data lengkap diterima."
  },
  {
    icon: <ShieldCheck className="w-5.5 h-5.5 text-[#990202]" />,
    title: "Bebas Sanksi BKPM",
    desc: "Data diverifikasi & disusun sesuai format resmi agar terhindar dari penolakan, teguran, hingga pembekuan NIB."
  },
  {
    icon: <Award className="w-5.5 h-5.5 text-[#990202]" />,
    title: "Ditangani Tim Ahli",
    desc: "Tim kami berpengalaman menangani ratusan laporan LKPM lintas skala usaha — dari UMK sampai PMA."
  },
  {
    icon: <TrendingUp className="w-5.5 h-5.5 text-[#990202]" />,
    title: "Reminder Otomatis",
    desc: "Kami kirim pengingat H-30, H-14, & H-7 sebelum deadline agar Anda tidak pernah telat lapor lagi."
  }
];
  ...
  const pricingPackages: PricingPackage[] = [
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket LKPM Mikro Kecil. Mohon info lengkap biaya dan prosesnya.", "paket-lkpm-mikro-kecil", "/layanan/pelaporan-lkpm"),
      groups: [
        {
          title: "LAMA PROSES",
    ...
    },
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket LKPM Menengah Besar. Mohon info lengkap biaya dan prosesnya.", "paket-lkpm-menengah-besar", "/layanan/pelaporan-lkpm"),
      groups: [
        {
          title: "LAMA PROSES",
          items: [{ text: "1-3 hari kerja", checked: true }]
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                ...
                <div className="lg:col-span-7 space-y-6 text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-2">
                    ...
                    <a
                  href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai Pelaporan LKPM Online.", "hero-consult", "/layanan/pelaporan-lkpm")}
                      target="_blank"
              ...
              <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                  ...
                  <div className="lg:col-span-5 flex flex-col items-stretch space-y-4 max-w-[380px] w-full lg:ml-auto text-left">
                    <a
                      href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai Pelaporan LKPM.", "bottom-consult", "/layanan/pelaporan-lkpm")}
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai Pelaporan LKPM.", "bottom-consult-secondary", "/layanan/pelaporan-lkpm")}
                      target="_blank"
                      rel="noopener noreferrer"
