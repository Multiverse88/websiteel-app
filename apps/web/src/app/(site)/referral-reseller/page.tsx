          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col space-y-6 text-left">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
                <a
                  href={getWhatsAppLink("Halo EasyLegal, saya tertarik mendaftar Program Referral & Reseller tanpa modal.", "tertarik-mendaftar-program-referral-reseller-tanpa-modal", "/referral-reseller")}
                  target="_blank"
      ...
      <section id="cta" className="py-24 relative overflow-hidden bg-white border-t border-gray-100">
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <a
              href={getWhatsAppLink("Halo EasyLegal, saya siap gabung Program Referral & Reseller sekarang.", "siap-gabung-program-referral-reseller-sekarang", "/referral-reseller")}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href={getWhatsAppLink("Halo EasyLegal, saya ingin bertanya mengenai kemitraan referral.", "ingin-bertanya-mengenai-kemitraan-referral", "/referral-reseller")}
              target="_blank"
              rel="noopener noreferrer"
