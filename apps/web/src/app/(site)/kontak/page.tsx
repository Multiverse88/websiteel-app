    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-white py-8 sm:py-20 border-b border-border/40 overflow-hidden relative">
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8 relative z-10">
          ...
          {/* Breadcrumb */}
          <nav className="flex items-center space-x-2 text-[16px] sm:text-[16px] font-medium text-gray-500 mb-4 sm:mb-6">
            <Link href="/" className="flex items-center hover:text-[#990202] transition-colors gap-1">
              <Home className="w-3.5 h-3.5" />
              <span>Beranda</span>
            </Link>
            <span className="text-gray-300 font-normal">&gt;</span>
            <span className="text-[16px] sm:text-[16px] font-bold text-gray-900">Kontak</span>
          </nav>
          ...
          <div className="max-w-3xl space-y-3 sm:space-y-4">
            ...
            <div className="inline-flex items-center space-x-2 bg-[#FFF5F5] py-1 px-3 sm:py-1.5 sm:px-3.5 rounded-full border border-red-100 shadow-sm animate-pulse-subtle">
              ...
              <span className="text-[16px] sm:text-[16px] font-bold text-[#990202] tracking-wide">Hubungi Kami</span>
            </div>

            <h1 className="font-heading text-[16px] sm:text-[44px] lg:text-[48px] font-extrabold text-gray-950 leading-[1.25] sm:leading-tight tracking-tight mt-4 sm:mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-12">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 shadow-md border border-black/[0.04] shadow-[0_4px_20px_rgba(0,0,0,0.008)] hover:shadow-[0_12px_30px_rgba(0,0,0,0.03)] hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between group min-h-[220px] sm:min-h-[320px]">
              <div>
                ...
                {/* Tag */}
                <span className="text-[16px] sm:text-[16px] font-extrabold text-gray-400 uppercase tracking-widest block">
                  WhatsApp · Tercepat
                </span>
                
                {/* Title */}
                <h3 className="font-heading text-[16px] sm:text-[16px] font-extrabold text-gray-950 mt-1 sm:mt-2 leading-snug">
                  0817-770-048
                </h3>
                
                {/* Subtext */}
                <p className="text-[16px] sm:text-[16px] text-gray-500 leading-relaxed mt-2 sm:mt-3">
              ...
              {/* Action Link */}
              <a
                href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai legalitas bisnis.", "ingin-konsultasi-mengenai-legalitas-bisnis", "/kontak")}
                target="_blank"
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-7 bg-white shadow-md border border-black/[0.04] rounded-2xl sm:rounded-3xl shadow-sm p-5 sm:p-10">
              <div>
                <h2 className="text-[16px] sm:text-[16px] font-extrabold text-gray-950 mb-1 tracking-tight">Kirim pertanyaan Anda</h2>
                <p className="text-[16px] sm:text-[16px] text-gray-500 leading-relaxed font-normal">
                ...
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  {/* Error message */}
                  {formError && (
                    <div className="p-4 bg-red-50 border border-red-200 rounded-xl text-[16px] text-red-700 font-medium flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="relative">
                      <label className="text-[16px] font-bold text-gray-900 mb-2 block">Nama Lengkap*</label>
                      <input
                        type="text"
                        name="name"
                        required
                        ...
                        className={`w-full px-4 py-3 rounded-xl border ${errors.name ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:border-[#990202] focus:ring-1 focus:ring-[#990202] text-[16px] bg-white transition-all text-gray-900`}
                      />
                      {errors.name && <p className="absolute -bottom-5 left-1 text-[16px] text-red-500 font-medium">{errors.name}</p>}
                    </div>
                    <div>
                      <label className="text-[16px] font-bold text-gray-900 mb-2 block">Nama Bisnis / Perusahaan</label>
                      <input
                        type="text"
                        name="businessName"
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:border-[#990202] focus:ring-1 focus:ring-[#990202] text-[16px] bg-white transition-all text-gray-900"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="relative">
                      <label className="text-[16px] font-bold text-gray-900 mb-2 block">Email*</label>
                      <input
                        type="email"
                        name="email"
                        required
                        ...
                        className={`w-full px-4 py-3 rounded-xl border ${errors.email ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:border-[#990202] focus:ring-1 focus:ring-[#990202] text-[16px] bg-white transition-all text-gray-900`}
                      />
                      {errors.email && <p className="absolute -bottom-5 left-1 text-[16px] text-red-500 font-medium">{errors.email}</p>}
                    </div>
                    <div className="relative">
                      <label className="text-[16px] font-bold text-gray-900 mb-2 block">No. WhatsApp*</label>
                      <input
                        type="tel"
                        name="whatsapp"
                        required
                        ...
                        className={`w-full px-4 py-3 rounded-xl border ${errors.whatsapp ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:border-[#990202] focus:ring-1 focus:ring-[#990202] text-[16px] bg-white transition-all text-gray-900`}
                      />
                      {errors.whatsapp && <p className="absolute -bottom-5 left-1 text-[16px] text-red-500 font-medium">{errors.whatsapp}</p>}
                    </div>
                  </div>

                  {/* Topik */}
                  <div className="relative">
                    <label className="text-[16px] font-bold text-gray-900 mb-2 block">
                      Topik Konsultasi*
                    </label>
                    <div className="relative">
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-3 rounded-xl border ${errors.topic ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:border-[#990202] focus:ring-1 focus:ring-[#990202] text-[16px] bg-white transition-all appearance-none cursor-pointer text-gray-700`}
                      >
                    ...
                    {errors.topic && <p className="absolute -bottom-5 left-1 text-[16px] text-red-500 font-medium">{errors.topic}</p>}
                  </div>

                  {/* Pesan */}
                  <div className="relative">
                    <label className="text-[16px] font-bold text-gray-900 mb-2 block">Pesan / Pertanyaan*</label>
                    <textarea
                      name="message"
                      required
                      rows={4}
                      ...
                      className={`w-full px-4 py-3 rounded-xl border ${errors.message ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:border-[#990202] focus:ring-1 focus:ring-[#990202] text-[16px] bg-white transition-all text-gray-900 resize-none leading-relaxed`}
                    />
                    {errors.message && <p className="absolute -bottom-5 left-1 text-[16px] text-red-500 font-medium">{errors.message}</p>}
                  </div>

                  {/* Consent Text Statement */}
                  <div className="text-[16px] text-gray-500 leading-relaxed mt-6">
                  ...
                  <button
                    type="submit"
                    disabled={isPending}
                    className="w-full py-4 bg-[#990202] hover:bg-[#800000] text-white font-bold text-[16px] rounded-xl shadow-sm hover:shadow transition-all duration-200 flex justify-center items-center gap-2 group cursor-pointer disabled:opacity-50 disabled:pointer-events-none"
                  >
                    {isPending ? (
                      <>
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="bg-[#EBF7EE] border border-[#D2ECD6] rounded-2xl p-5 flex items-center space-x-4">
                ...
                <div>
                  <div className="text-[16px] font-bold text-[#0F763E]">Respons cepat</div>
                  <div className="text-[16px] text-[#1E5C39] font-medium mt-0.5">Rata-rata kurang dari 5 menit via WhatsApp.</div>
                </div>
              </div>
              ...
              <div className="bg-white shadow-md border border-black/[0.04] rounded-2xl p-6">
                <div className="flex items-center space-x-3 mb-5">
                  ...
                  <span className="text-[16px] font-bold text-gray-900">Jam Operasional</span>
                </div>
                
                <div className="space-y-0 text-[16px] text-gray-600 font-medium">
              ...
              <div className="bg-white shadow-md border border-black/[0.04] rounded-2xl p-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <span className="text-[16px] font-bold text-gray-900">Kantor Pusat</span>
                </div>
                <p className="text-[16px] text-gray-500 leading-relaxed pl-8">
                  Jl. Cihampelas No.201A, Cipaganti, Kecamatan Coblong, Kota Bandung, Jawa Barat 40131
                </p>
                <div className="mt-5 pl-8">
                  <Link
                    href="/tentang-kami"
                    className="inline-flex items-center text-[16px] font-extrabold text-[#990202] hover:text-[#800000] gap-1 group transition-all duration-200"
                  >
      ...
      {formSubmitted && (
        <div className="fixed bottom-6 right-6 z-50 animate-slide-down">
          <div className="bg-white shadow-sm border border-black/[0.03] rounded-2xl p-5 shadow-2xl max-w-xs flex items-start space-x-3 relative">
            ...
            <div>
              <div className="text-[16px] font-bold text-dark mb-1">Pertanyaan Dikirim!</div>
