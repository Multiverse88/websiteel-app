      ...
      cards: [
        {
          ...
          buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Layanan Cek Merek Manual. Mohon info biaya dan prosesnya.", "layanan-cek-merek-manual", "/layanan/merek-haki"),
          groups: [
            {
              title: "LAMA PROSES",
              items: [
        ...
        },
        {
          ...
          buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Layanan Cek Merek AI. Mohon info biaya dan prosesnya.", "layanan-cek-merek-ai", "/layanan/merek-haki"),
          groups: [
            {
              title: "LAMA PROSES",
              items: [
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative w-full flex items-center justify-center mt-8 lg:mt-0">
              <div className="relative w-full max-w-[480px] lg:max-w-none px-4 sm:px-0">
                ...
                <div className="absolute bottom-[76px] -right-2 sm:-right-4 bg-white rounded-2xl p-3.5 pr-6 shadow-[0_15px_35px_rgba(0,0,0,0.06)] shadow-md border border-black/[0.03] flex items-center space-x-3.5 w-[215px] transition-transform hover:-translate-y-1 duration-300">
                  <div className="w-8.5 h-8.5 sm:w-10 sm:h-10 rounded-xl bg-red-50 flex items-center justify-center text-[#990202] flex-shrink-0">
      ...
      <section className="bg-white py-8 sm:py-8 sm:py-20 border-b border-gray-200/40">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8">
          ...
          <div className="mb-14 text-center max-w-3xl mx-auto flex flex-col items-center">
            <p className="text-[16px] font-extrabold text-[#990202] uppercase tracking-[0.15em] mb-2">PENGERTIAN MEREK</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 relative w-full flex items-center justify-center">
              <div className="relative w-full max-w-[500px] lg:max-w-none">
                ...
                <div className="absolute bottom-[76px] left-4 bg-white rounded-2xl p-4 pr-6 shadow-[0_15px_35px_rgba(0,0,0,0.06)] shadow-md border border-black/[0.03] flex items-center space-x-3.5 w-[280px] sm:w-[320px]">
      ...
      <CTA
        ...
        whatsappLink={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai layanan Pendaftaran Merek & HAKI.", "bottom-consult", "/layanan/merek-haki")}
