          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <nav className="flex items-center space-x-2 text-[16px] font-medium text-gray-500">
                ...
                <span className="text-gray-300 font-normal">&gt;</span>
                <span className="text-[16px] font-bold text-gray-900">{c.heroBreadcrumbText}</span>
              </nav>
              ...
              <div className="flex flex-col sm:flex-row gap-3.5 pt-2">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center px-7 py-4 shadow-md border border-black/[0.04] text-gray-800 font-bold text-[16px] rounded-xl hover:bg-gray-50 hover:border-gray-300 hover:-translate-y-0.5 transition-all duration-200 text-center shadow-sm cursor-pointer"
                >
                  Lihat Paket Harga
                </a>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 pt-8 border-t border-gray-100 max-w-[580px]">
                {c.heroStats.map((stat, idx) => (
                  <div key={idx} className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="text-[16px] sm:text-[16px] font-extrabold text-gray-950 leading-tight">{stat.value}</div>
              ...
              <div className="relative w-full max-w-[480px] lg:max-w-none px-4 sm:px-0">
                ...
                {c.floatingBadges.map((badge, idx) => (
                  ...
                  >
                    ...
                    <div>
                      <div className="text-[16px] font-black text-gray-900 leading-none">{badge.title}</div>
                      <div className="text-[16px] text-gray-400 font-bold mt-1.5">{badge.subtitle}</div>
                    </div>
                  </div>
                ))}
      ...
      <section className="bg-[#F9FAFB] py-20 border-b border-gray-200/40">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            <p className="text-[16px] font-extrabold text-[#990202] uppercase tracking-widest">{c.stepsTag}</p>
            <h2 className="font-heading text-[36px] sm:text-[42px] font-extrabold text-gray-950 leading-tight">
              {c.stepsTitle}
            </h2>
            <p className="text-[16px] sm:text-[16px] text-gray-500 font-medium">
              {c.stepsSubtitle}
            </p>
            ...
            >
              {c.steps.map((step, idx) => (
                <div key={idx} className="relative flex flex-col min-w-[280px] sm:min-w-[320px] max-w-[320px] group snap-start pt-5">
                  ...
                  <div className="absolute top-0 left-6 w-10 h-10 rounded-full border-2 border-[#990202] text-[#990202] bg-white flex items-center justify-center font-black text-[16px] z-20 shadow-sm transition-transform duration-300 group-hover:scale-110">
                    {step.no}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-5 relative flex items-center justify-center">
              <div className="relative w-full max-w-[480px] lg:max-w-none">
                ...
                <div className="absolute -bottom-10 left-4 sm:left-6 bg-white rounded-2xl p-4 shadow-[0_15px_35px_rgba(0,0,0,0.06)] shadow-sm border border-black/[0.02] flex items-center space-x-3.5 w-[250px] transition-transform hover:-translate-y-1 duration-300 z-10">
                  ...
                  <div>
                    <div className="text-[16px] font-black text-gray-900 leading-none">{c.hukumTitle}</div>
                    <div className="text-[16px] text-gray-400 font-bold mt-1.5 leading-snug">{c.hukumLaw}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="text-[16px] text-gray-600 leading-relaxed font-normal space-y-4">
                {c.pengertianDetail}
              </div>
              ...
              <div className="pt-4">
                ...
                <ul className="space-y-4">
                  {c.karakteristik.map((item, idx) => (
                    <li key={idx} className="flex items-start text-[16px] text-gray-600">
      ...
      <section className="bg-[#F9FAFB] py-20 border-b border-gray-200/40">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <p className="text-[16px] font-extrabold text-[#990202] uppercase tracking-wider">{c.manfaatTag}</p>
            <h2 className="font-heading text-[36px] sm:text-[42px] font-extrabold text-gray-950 leading-tight">
              {c.manfaatTitle}
            </h2>
          </div>
