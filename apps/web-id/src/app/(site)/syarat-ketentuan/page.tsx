...
const sections = [
  {
    ...
    content: `Dengan mengakses atau menggunakan website EasyLegal dan layanan yang tersedia, Anda menyetujui untuk terikat oleh Syarat & Ketentuan ini. Jika Anda tidak menyetujui salah satu ketentuan ini, mohon untuk tidak menggunakan layanan kami.`,
  },
  {
