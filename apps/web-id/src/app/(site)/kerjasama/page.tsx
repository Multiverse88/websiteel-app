            ...
            {!isSuccess ? (
              ...
              <div className="space-y-6 text-center py-6 animate-fadeIn">
                ...
                <div className="pt-4 flex flex-col sm:flex-row justify-center gap-3 max-w-md mx-auto">
                  <a
                    href={getWhatsAppLink(`Halo Partnership Manager EasyLegal, saya ${formData.name} baru saja mengajukan kemitraan ${formData.partnershipType} via formulir website.`, "form-follow-up", "/kerjasama")}
                    target="_blank"
