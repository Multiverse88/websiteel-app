  ...
  const pricingPackages: PricingPackage[] = [
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket PKKPR Lahan 0 - 3,9 HA. Mohon info lengkap biaya dan prosesnya.", "paket-pkkpr-lahan-0-3-9-ha", "/layanan/pkkpr"),
      groups: [
        {
          title: "LAMA PROSES",
    ...
    },
    {
      ...
      isPopular: false,
      buttonText: "Pilih PAKET PKKPR",
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket PKKPR Lahan 4 - 4,9 HA. Mohon info lengkap biaya dan prosesnya.", "paket-pkkpr-lahan-4-4-9-ha", "/layanan/pkkpr"),
      groups: [
        {
          title: "LAMA PROSES",
          items: [{ text: "<strong className=\"font-extrabold text-gray-900\">3-5 hari kerja</strong> <span className=\"text-red-600 text-[10px] font-bold\">(1)</span>", checked: true }]
    ...
    },
    {
      ...
      isPopular: false,
      buttonText: "Pilih PAKET PKKPR",
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket PKKPR Lahan 5 - 9,9 HA. Mohon info lengkap biaya dan prosesnya.", "paket-pkkpr-lahan-5-9-9-ha", "/layanan/pkkpr"),
      groups: [
        {
          title: "LAMA PROSES",
          items: [{ text: "<strong className=\"font-extrabold text-gray-900\">3-5 hari kerja</strong> <span className=\"text-red-600 text-[10px] font-bold\">(1)</span>", checked: true }]
    ...
    },
    {
      ...
      isPopular: false,
      buttonText: "Pilih PAKET PKKPR",
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket PKKPR Lahan 10 - 20 HA. Mohon info lengkap biaya dan prosesnya.", "paket-pkkpr-lahan-10-20-ha", "/layanan/pkkpr"),
      groups: [
        {
          title: "LAMA PROSES",
          items: [{ text: "<strong className=\"font-extrabold text-gray-900\">3-5 hari kerja</strong> <span className=\"text-red-600 text-[10px] font-bold\">(1)</span>", checked: true }]
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                ...
                <div className="lg:col-span-7 space-y-6 text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-2">
                    ...
                    <a
                  href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai Tata Ruang • PKKPR Online.", "hero-consult", "/layanan/pkkpr")}
                      target="_blank"
              ...
              <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                  ...
                  <div className="lg:col-span-5 flex flex-col items-stretch space-y-4 max-w-[380px] w-full lg:ml-auto text-left">
                    <a
                      href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai Tata Ruang • PKKPR.", "bottom-consult", "/layanan/pkkpr")}
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai Tata Ruang • PKKPR.", "bottom-consult-secondary", "/layanan/pkkpr")}
                      target="_blank"
                      rel="noopener noreferrer"
