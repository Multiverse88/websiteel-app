  ...
  const pricingPackages: PricingPackage[] = [
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket A Press Release. Mohon info lengkap biaya dan prosesnya.", "paket-a-press-release", "/layanan/press-release"),
      groups: [
        {
          title: "LAMA PROSES",
    ...
    },
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket B Press Release. Mohon info lengkap biaya dan prosesnya.", "paket-b-press-release", "/layanan/press-release"),
      groups: [
        {
          title: "LAMA PROSES",
          items: [{ text: "<strong className=\"font-extrabold text-gray-900\">1–3 hari kerja</strong> sampai terbit", checked: true }]
    ...
    },
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket C Press Release. Mohon info lengkap biaya dan prosesnya.", "paket-c-press-release", "/layanan/press-release"),
      groups: [
        {
          title: "LAMA PROSES",
          items: [{ text: "<strong className=\"font-extrabold text-gray-900\">1–3 hari kerja</strong> sampai terbit", checked: true }]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                ...
                <a
                  href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai layanan Press Release.", "hero-consult", "/layanan/press-release")}
                  target="_blank"
            ...
            <div className="lg:col-span-5 relative w-full flex flex-col items-center justify-center mt-8 lg:mt-0">
              <div className="relative w-full max-w-[460px] aspect-[1.05] sm:aspect-square lg:aspect-[1.05]">
                ...
                <div className="absolute -top-14 -left-6 sm:-top-16 sm:-left-24 lg:-top-20 lg:-left-32 xl:-left-40 bg-white rounded-2xl p-3.5 shadow-[0_20px_40px_rgba(0,0,0,0.06)] flex items-center space-x-3 w-[220px] hover:-translate-y-1 transition-transform duration-300 z-20">
      ...
      <section className="bg-white py-8 sm:py-8 sm:py-20 border-t border-gray-100">
        <div className="max-w-[1140px] mx-auto px-6 sm:px-8 flex flex-col md:flex-row items-center justify-between gap-12 text-left">
          ...
          <div className="w-full md:w-auto flex flex-col gap-3 min-w-[320px] sm:min-w-[360px] max-w-[400px]">
            {/* WhatsApp Action */}
            <a
              href={getWhatsAppLink("Halo EasyLegal, saya ingin konsultasi mengenai publikasi Press Release.", "bottom-consult", "/layanan/press-release")}
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* Email/Form Action */}
            <a
              href={getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Jasa Publikasi Press Release Media. Mohon info lengkap biaya dan prosesnya.", "jasa-publikasi-press-release-media", "/layanan/press-release")}
              target="_blank"
              rel="noopener noreferrer"
