...
const pricingPackages = [
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket NIB Perseorangan (UMK). Mohon info lengkap biaya dan prosesnya.", "paket-nib-perseorangan-umk", "/layanan/nib-oss"),
    ...
    },
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket NIB Badan Usaha (PT/CV). Mohon info lengkap biaya dan prosesnya.", "paket-nib-badan-usaha-pt-cv", "/layanan/nib-oss"),
      duration: "1-2 Hari Kerja",
      features: [
    ...
    },
    {
      ...
      buttonLink: getWhatsAppLink("Halo EasyLegal, saya tertarik dengan Paket NIB + Sertifikat Standar. Mohon info lengkap biaya dan prosesnya.", "paket-nib-sertifikat-standar", "/layanan/nib-oss"),
