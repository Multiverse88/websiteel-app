...
export async function middleware(request: NextRequest) {
  ...
  // HTTP 410: Artikel yang telah dihilangkan dari domain ini atau dihapus permanen
        ...
        if (res.status === 410) {
          return new NextResponse(
            render410Html(
              ...
              "Artikel ini telah dihilangkan secara permanen dari domain ini dan tidak lagi tersedia.",
            ),
            {
              status: 410,
              statusText: "Gone",
