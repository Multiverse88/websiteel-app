...
content = content.replace("export default function VirtualOffice() {", locations_data)

new_section = """      {/* ─── 3.5 DETAIL LOKASI SECTION ─── */}
      <section className="py-8 sm:py-8 sm:py-8 sm:py-20 bg-[#F9FAFB] border-b border-gray-100 space-y-16 sm:space-y-32">
        {locationsData.map((loc, idx) => (
          <div key={loc.id} className="max-w-[1240px] mx-auto px-4 sm:px-8">
            {/* Section Header */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
              ...
              <div className="animate-fade-in-up lg:col-span-6 relative">
              ...
              <div className="animate-fade-in-up lg:col-span-6 space-y-4 sm:space-y-6">
                {/* Address Card */}
...
# Find the start and end of the detail lokasi section
