    ...
    <section id="footer-cta" className="py-8 sm:py-20 bg-white border-t border-gray-100 overflow-hidden relative">
      ...
      >
        ...
        <div className="flex flex-col text-left max-w-xl">
          {title}
          <div className="text-[14px] sm:text-[14.5px] text-gray-500 leading-relaxed mt-2.5 sm:mt-4 max-w-[460px] font-normal">
            {description}
          </div>
        </div>
        ...
        <div className="flex flex-col items-start w-full lg:w-[380px] flex-shrink-0">
          <a
            ...
            className="w-full bg-[#990202] hover:bg-[#800000] text-white font-extrabold py-2.5 sm:py-3.5 px-6 rounded-lg sm:rounded-xl flex items-center justify-center gap-2 text-[14px] sm:text-[14px] shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
          >
          ...
          <Link
            href={contactLink}
            className="w-full mt-2 bg-white shadow-md border border-black/[0.04] text-gray-800 hover:bg-gray-50 hover:border-gray-300 font-extrabold py-2.5 sm:py-3.5 px-6 rounded-lg sm:rounded-xl flex items-center justify-center gap-2 text-[14px] sm:text-[14.5px] shadow-sm hover:shadow hover:-translate-y-0.5 transition-all duration-200"
          >
          ...
          <div className="flex items-center gap-1.5 mt-2.5 sm:mt-4 text-[14px] sm:text-[14px] text-gray-500 font-bold leading-none pl-1">
