      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-6 sm:mb-12 gap-4">
          <div className="text-left">
            ...
            <p className="text-[11.5px] sm:text-[14.5px] text-[#6B7280] mt-2 max-w-[540px] leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8 items-start">
              ...
              <div className="p-4 sm:p-6 flex-grow flex flex-col justify-between">
                <div>
                  <div className="flex items-center">
                    ...
                    <span className="text-[10px] sm:text-[10.5px] text-gray-500 font-bold ml-3.5">
                  ...
                  <p className="text-[11px] sm:text-[13px] text-[#6B7280] leading-relaxed mt-2 sm:mt-3 font-medium line-clamp-3">
                    {featured.excerpt}
                  </p>
                </div>
              </div>
          ...
          {/* Grid Articles */}
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 h-full">
              ...
              >
                ...
                <div className="p-4 flex-grow flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-xs sm:text-[14px] lg:text-[14.5px] font-black text-[#111827] mt-2 sm:mt-3 leading-snug group-hover:text-[#B91C1C] transition-colors line-clamp-2">
                      {article.title}
                    </h3>
                  </div>
                </div>
