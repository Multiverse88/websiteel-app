          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-24">
            <div className="lg:w-[55%] text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#FEF2F2] border border-[#FEE2E2] mb-4 sm:mb-6">
                ...
                <span className="text-[10px] sm:text-[12.5px] font-extrabold text-[#B91C1C]">
                  {c.heroBadge}
                </span>
              </div>
              ...
              <p className="text-[12.5px] sm:text-[16px] text-gray-500 mt-4 sm:mt-5 leading-relaxed max-w-[580px] font-medium font-sans">
                {c.heroDescription}
              </p>
              ...
              <div className="flex flex-row gap-3 mt-6 sm:mt-8">
                <a
                  ...
                  className="flex-1 sm:flex-initial text-center justify-center px-4 sm:px-7 py-3 sm:py-3.5 bg-[#990202] hover:bg-[#800000] text-white font-extrabold rounded-xl text-[12px] sm:text-[14px] shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-1.5 sm:gap-2"
                >
                ...
                {c.heroStats.map((stat, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-[12px] sm:text-[14px] font-extrabold text-gray-950">{stat.value}</div>
                        <div className="text-[10px] sm:text-[12px] text-gray-600 font-medium">{stat.label}</div>
                      </div>
                    </div>
                  );
                })}
            ...
            {c.benefits.map((b, i) => {
              ...
              return (
                <div key={i} className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-100 shadow-sm">
                  ...
                  <p className="text-[11px] sm:text-sm text-gray-500 leading-relaxed font-medium">{b.desc}</p>
                </div>
              );
            })}
          </div>
