  ...
  return (
    <section className="bg-white py-24">
      <div className="max-w-[850px] mx-auto px-6 sm:px-8">
        <div
          ref={headerRef}
          className={`text-center mb-16 space-y-3 transition-all duration-500 ${headerVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}
        >
        ...
        <div
          ref={listRef}
          className={`space-y-4 transition-all duration-500 delay-200 ${listVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}
        >
          {items.map((faq, idx) => {
