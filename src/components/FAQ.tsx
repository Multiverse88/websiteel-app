      ...
      <div className="max-w-[850px] mx-auto px-4 sm:px-8">
        ...
        >
          {items.map((faq, idx) => {
            ...
            return (
              <div key={idx} className={`py-5 sm:py-6 border-b border-gray-100 last:border-0 transition-all duration-300`}>
                <button
                ...
                >
                  <p
                    className="text-[16px] sm:text-[16px] text-gray-500 leading-relaxed font-medium pr-4 sm:pr-12"
