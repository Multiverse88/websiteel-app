...
export default function TentangKami() {
  ...
  const offices = [
    { city: "Bandung", tag: "Kantor Pusat", addr: "Jl. Asia Afrika No. 1, Sumur Bandung, Kota Bandung, Jawa Barat 40111", hours: "Sen–Sab · 08–17", tel: "022-1234-5678", map: "https://maps.google.com", img: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?fit=crop&w=600&h=400&q=80" },
    { city: "Jakarta", tag: "Branch Office", addr: "Jl. Jenderal Sudirman Kav. 52-53, Setiabudi, Jakarta Selatan, DKI Jakarta 12190", hours: "Sen–Sab · 08–17", tel: "021-1234-5678", map: "https://maps.google.com", img: "https://images.unsplash.com/photo-1497366216548-37526070297c?fit=crop&w=600&h=400&q=80" },
    { city: "Bekasi", tag: "Branch Office", addr: "Jl. Ahmad Yani No. 10, Marga Jaya, Bekasi Selatan, Kota Bekasi, Jawa Barat 17141", hours: "Sen–Sab · 08–17", tel: "021-9876-5432", map: "https://maps.google.com", img: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?fit=crop&w=600&h=400&q=80" },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-bg-light py-20 border-b border-border/40 overflow-hidden">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
            <p className="text-[12px] font-extrabold text-[#990202] uppercase tracking-wider">Kantor Kami</p>
            <h2 className="font-inter text-[36px] sm:text-[42px] font-extrabold text-gray-950 leading-tight">
