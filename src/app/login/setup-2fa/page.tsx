    ...
    return (
      <div className="flex items-center justify-center min-h-[80vh] px-4">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-[16px] text-gray-500 font-medium">Menyiapkan 2FA...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-center min-h-[80vh] px-4">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-md border border-black/[0.04] shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-8 text-center">
            <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-xl text-[16px] text-[#990202] font-semibold">
              {error}
            </div>
            <Link
              href="/login"
              className="text-[16px] text-[#990202] hover:text-[#800000] transition-colors font-semibold"
            >
              Kembali ke login
            </Link>
          </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-md border border-black/[0.04] shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-8">
          ...
          <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl">
            <p className="text-[16px] text-amber-800 font-semibold mb-2">
              Langkah-langkah:
            </p>
            <ol className="text-[16px] text-amber-700 space-y-1.5 list-decimal list-inside">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label htmlFor="token" className="text-[16px] font-extrabold text-gray-900 flex items-center gap-1.5">
              ...
              <input
                ...
                required
                placeholder="000000"
                className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-[16px] tracking-[0.3em] text-center font-semibold placeholder-gray-400 focus:outline-none focus:border-[#990202] focus:ring-4 focus:ring-red-100 transition-all text-gray-950"
              />
            </div>
          ...
          <div className="mt-6 text-center">
            <Link
              href="/login"
              className="text-[16px] text-gray-500 hover:text-[#990202] transition-colors font-medium"
            >
              Kembali ke login
            </Link>
          </div>
