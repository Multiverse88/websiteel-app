            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8 border-t border-gray-150 max-w-[620px]">
                ...
                <div className="flex items-center space-x-3 bg-gray-50/50 p-2.5 rounded-xl border border-gray-100 shadow-sm">
                  ...
                  <div>
                    <div className="text-[13.5px] font-black text-gray-955">1–3 Hari</div>
                    <div className="text-[10.5px] text-gray-500 font-semibold">Berita terbit</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 bg-gray-50/50 p-2.5 rounded-xl border border-gray-100 shadow-sm">
                  ...
                  <div>
                    <div className="text-[13.5px] font-black text-gray-955">100+ Media</div>
                    <div className="text-[10.5px] text-gray-500 font-semibold">Pilihan publikasi</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 bg-gray-50/50 p-2.5 rounded-xl border border-gray-100 shadow-sm">
                  ...
                  <div>
                    <div className="text-[13.5px] font-black text-gray-955">100% Garansi</div>
                    <div className="text-[10.5px] text-gray-500 font-semibold">Berita tayang</div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative w-full max-w-[460px] aspect-[1.05] sm:aspect-square lg:aspect-[1.05]">
                ...
                <div className="absolute -top-6 -left-6 bg-white rounded-2xl p-3.5 shadow-[0_20px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex items-center space-x-3 w-[220px] hover:-translate-y-1 transition-transform duration-300 z-20">
                  ...
                  <div className="text-left">
                    <div className="text-[12.5px] font-black text-gray-955 leading-none">100+ Media Nasional</div>
                ...
                <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-3.5 shadow-[0_20px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex items-center space-x-3 w-[215px] hover:-translate-y-1 transition-transform duration-300 z-20">
                  ...
                  <div className="text-left">
                    <div className="text-[12.5px] font-black text-gray-955 leading-none">Permanen Online</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[1140px] mx-auto items-stretch text-left">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-150 shadow-sm hover:shadow-md transition-all duration-250 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <h4 className="text-[15px] font-black text-gray-955 leading-tight">Launching Produk / Brand</h4>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-150 shadow-sm hover:shadow-md transition-all duration-250 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <h4 className="text-[15px] font-black text-gray-955 leading-tight">Liputan Event &amp; Aktivitas</h4>
                <p className="text-[12.5px] text-gray-500 font-semibold leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-150 shadow-sm hover:shadow-md transition-all duration-250 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <h4 className="text-[15px] font-black text-gray-955 leading-tight">Verifikasi Centang Biru</h4>
                <p className="text-[12.5px] text-gray-500 font-semibold leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-150 shadow-sm hover:shadow-md transition-all duration-250 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <h4 className="text-[15px] font-black text-gray-955 leading-tight">Syarat Shopee Mall &amp; Marketplace</h4>
                <p className="text-[12.5px] text-gray-500 font-semibold leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-150 shadow-sm hover:shadow-md transition-all duration-250 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <h4 className="text-[15px] font-black text-gray-955 leading-tight">Brand Building Jangka Panjang</h4>
                <p className="text-[12.5px] text-gray-500 font-semibold leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-150 shadow-sm hover:shadow-md transition-all duration-250 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <h4 className="text-[15px] font-black text-gray-955 leading-tight">Klarifikasi Publik / Hoaks</h4>
                <p className="text-[12.5px] text-gray-500 font-semibold leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-[1140px] mx-auto items-stretch text-left">
            ...
            <div className="bg-white rounded-2xl p-5.5 border border-gray-150 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition-shadow duration-200">
              <div className="space-y-3">
                ...
                <h4 className="text-[14px] font-black text-gray-955 leading-tight">Bangun Kepercayaan</h4>
            ...
            <div className="bg-white rounded-2xl p-5.5 border border-gray-150 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition-shadow duration-200">
              <div className="space-y-3">
                ...
                <h4 className="text-[14px] font-black text-gray-955 leading-tight">Reputasi &amp; Otoritas</h4>
                <p className="text-[11.5px] text-gray-500 font-semibold leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5.5 border border-gray-150 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition-shadow duration-200">
              <div className="space-y-3">
                ...
                <h4 className="text-[14px] font-black text-gray-955 leading-tight">Boost Promosi</h4>
                <p className="text-[11.5px] text-gray-500 font-semibold leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5.5 border border-gray-150 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition-shadow duration-200">
              <div className="space-y-3">
                ...
                <h4 className="text-[14px] font-black text-gray-955 leading-tight">Kredibilitas Tinggi</h4>
                <p className="text-[11.5px] text-gray-500 font-semibold leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5.5 border border-gray-150 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition-shadow duration-200">
              <div className="space-y-3">
                ...
                <h4 className="text-[14px] font-black text-gray-955">Jangkauan Luas</h4>
                <p className="text-[11.5px] text-gray-500 font-semibold leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5.5 border border-gray-150 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition-shadow duration-200">
              <div className="space-y-3">
                ...
                <h4 className="text-[14px] font-black text-gray-955">SEO &amp; Brand Search</h4>
                <p className="text-[11.5px] text-gray-500 font-semibold leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5.5 border border-gray-150 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition-shadow duration-200">
              <div className="space-y-3">
                ...
                <h4 className="text-[14px] font-black text-gray-955">Permanen Online</h4>
                <p className="text-[11.5px] text-gray-500 font-semibold leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5.5 border border-gray-150 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition-shadow duration-200">
              <div className="space-y-3">
                ...
                <h4 className="text-[14px] font-black text-gray-955">Kompetitif vs Iklan</h4>
                <p className="text-[11.5px] text-gray-500 font-semibold leading-relaxed">
      ...
      <section id="paket-harga" className="bg-[#FBFBFA] py-24 border-b border-gray-200/50 scroll-mt-16">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-[1180px] mx-auto items-stretch text-left">
            ...
            {/* Paket A */}
            <div className="bg-white rounded-[24px] overflow-hidden border border-gray-200/80 shadow-md flex flex-col justify-between transition-all duration-300 hover:shadow-xl">
              <div>
                {/* Header */}
            ...
            {/* Paket B */}
            <div className="bg-white rounded-[24px] overflow-hidden border-2 border-[#990202] shadow-xl flex flex-col justify-between transition-all duration-300 hover:shadow-2xl relative scale-[1.02] z-10">
              <div>
                {/* Header */}
          ...
          <div className="max-w-[1180px] mx-auto bg-[#F0F0F0] rounded-3xl py-5 px-6 sm:py-6.5 sm:px-9 border border-gray-200 mt-8 sm:mt-10 text-left space-y-3 shadow-[0_8px_30px_rgba(0,0,0,0.035)]">
