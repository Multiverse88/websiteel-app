...
export default function MerekHaki() {
  ...
  const hakiBenefits = [
    ...
    {
      icon: <span className="text-[20px] font-black text-[#990202]">$</span>,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 relative w-full flex items-center justify-center">
              <div className="relative w-full max-w-[500px] lg:max-w-none">
                ...
                <div className="absolute -bottom-6 left-4 bg-white rounded-2xl p-4 pr-6 shadow-[0_15px_35px_rgba(0,0,0,0.06)] border border-gray-150/50 flex items-center space-x-3.5 w-[280px] sm:w-[320px]">
                  <div className="w-10 h-10 rounded-xl bg-[#990202] text-white flex items-center justify-center flex-shrink-0">
      ...
      <section className="bg-[#F9FAFB] py-20 border-b border-gray-200/40">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10 space-y-3">
            ...
            <h2 className="font-inter text-[36px] sm:text-[42px] font-extrabold text-gray-950 leading-tight text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3.5 mb-16">
            {additionalTabs.map((tab) => {
              ...
              const tabClass = isActive
                ...
                : "inline-flex items-center space-x-2 bg-white text-gray-600 hover:text-gray-800 py-3 px-6 rounded-2xl border border-gray-200 hover:border-gray-300 font-bold text-[14px] shadow-sm hover:shadow transition-all duration-200 cursor-pointer";
              return (
                <button
                  key={tab.id}
          ...
          {(() => {
            ...
            return (
              <div className="space-y-12">
                ...
                {/* Tab Footnote Box */}
                {currentTab.footnote && (
                  <div className="bg-white border border-gray-150/40 rounded-2xl p-5 text-[11.5px] text-gray-500 leading-relaxed max-w-[960px] mx-auto font-medium shadow-sm">
      ...
      <section className="bg-white py-20 border-b border-gray-200/40">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-[1080px] mx-auto items-stretch">
            ...
            <div className="bg-white border border-gray-150/60 rounded-3xl p-6.5 sm:p-8 shadow-[0_4px_25px_rgba(0,0,0,0.01)] hover:shadow-[0_12px_40px_rgba(0,0,0,0.03)] hover:border-gray-200 transition-all duration-300 flex flex-col space-y-6">
