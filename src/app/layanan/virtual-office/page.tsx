    ...
    <div className="bg-white min-h-screen pt-[25px]">
      ...
      <section className="relative py-8 sm:py-8 sm:py-8 sm:py-20 overflow-hidden bg-white">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8 relative z-10">
          {/* Breadcrumbs */}
          <nav className="flex items-center gap-2 text-[11px] sm:text-[13px] text-gray-600 pt-0 pb-1 mb-1 font-medium">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-24">
            <div className="lg:w-[55%] text-left">
              ...
              >
                ...
                <span className="text-[10px] sm:text-[12.5px] font-extrabold text-[#B91C1C]">Virtual Office EasyLegal</span>
              </div>
              ...
              <p 
                className="animate-fade-in-up text-[12.5px] sm:text-[16px] text-gray-500 mt-4 sm:mt-5 leading-relaxed max-w-[580px] font-medium font-sans"
              ...
              >
                <a
                  ...
                  className="flex-1 sm:flex-initial text-center justify-center px-4 sm:px-7 py-3 sm:py-3.5 bg-[#990202] hover:bg-[#800000] text-white font-extrabold rounded-xl text-[12px] sm:text-[12px] sm:text-[14px] shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-1.5 sm:gap-2"
                >
              ...
              {/* Bottom Features */}
              <div 
                className="animate-fade-in-up grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-14 pt-6 sm:pt-8 border-t border-gray-100/80"
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[12px] sm:text-[14px] font-extrabold text-gray-950">3 Kota</div>
                    <div className="text-[10px] sm:text-[12px] text-gray-600 font-medium">Bandung &middot; Jakarta &middot; Bekasi</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[12px] sm:text-[14px] font-extrabold text-gray-950">70 jam/tahun</div>
                    <div className="text-[10px] sm:text-[12px] text-gray-600 font-medium">Meeting room gratis</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[12px] sm:text-[14px] font-extrabold text-gray-950">PKP-friendly</div>
                    <div className="text-[10px] sm:text-[12px] text-gray-600 font-medium">Legalitas lengkap</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div 
              className="animate-fade-in lg:w-[45%] relative mt-8 lg:mt-0"
              style={{ animationDelay: "0.2s" }}
            >
              ...
              <div className="absolute top-12 left-[-32px] z-20 hidden sm:flex items-center gap-4 p-4.5 bg-white rounded-2xl shadow-[0_15px_30px_rgba(0,0,0,0.06)] max-w-[245px] hover:scale-105 transition-transform duration-300">
                ...
                <div>
                  ...
                  <div className="text-[11.5px] text-gray-500 font-medium mt-1">Pakai untuk PT, NPWP, PKP</div>
                </div>
              </div>
              ...
              <div className="absolute bottom-12 right-[-24px] z-20 hidden sm:flex items-center gap-4 p-4.5 bg-white rounded-2xl shadow-[0_15px_30px_rgba(0,0,0,0.06)] max-w-[265px] hover:scale-105 transition-transform duration-300">
                ...
                <div>
                  ...
                  <div className="text-[11.5px] text-gray-500 font-medium mt-1">Legalitas gedung terverifikasi</div>
                </div>
              </div>
      ...
      <section className="py-8 sm:py-8 sm:py-8 sm:py-20 bg-white border-b border-gray-100">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
            ...
            >
              <div className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.08)] aspect-[4/3]">
                <Image
                ...
                <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 z-20 bg-white p-3 sm:p-4.5 rounded-xl sm:rounded-2xl shadow-[0_15px_30px_rgba(0,0,0,0.06)] max-w-[280px] flex items-center gap-2.5 sm:gap-3.5 hover:scale-105 transition-transform duration-300">
                  ...
                  <div>
                    <div className="text-[11.5px] sm:text-[13.5px] font-extrabold text-gray-950 leading-tight">3 Lokasi Strategis</div>
                    <div className="text-[9px] sm:text-[10.5px] text-gray-600 font-medium leading-tight mt-1">Cihampelas Bandung - Cilandak Jakarta - Summarecon Bekasi</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <p className="text-[12.5px] sm:text-[15px] text-gray-500 leading-relaxed font-medium">
                Berbeda dengan menyewa kantor konvensional, Virtual Office memberi Anda <strong className="font-extrabold text-gray-900">alamat prestisius</strong> di lokasi bisnis utama dengan biaya jauh lebih efisien - lengkap dengan fasilitas pendukung seperti meeting room, resepsionis, &amp; penerimaan surat.
              </p>
              ...
              <div>
                ...
                <ul className="space-y-2.5 sm:space-y-3.5">
                  <li className="flex items-start gap-2.5 sm:gap-3.5 text-[12px] sm:text-[11.5px] sm:text-[11.5px] sm:text-[14.5px] text-gray-500 font-medium leading-relaxed">
                    ...
                    <div>
                      <strong className="font-extrabold text-gray-900">Alamat komersial resmi</strong> - bisa dipakai untuk domisili PT/CV, NPWP, NIB, &amp; PKP.
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5 sm:gap-3.5 text-[12px] sm:text-[11.5px] sm:text-[11.5px] sm:text-[14.5px] text-gray-500 font-medium leading-relaxed">
                    <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center flex-shrink-0 text-emerald-500 mt-0.5">
                    ...
                    <div>
                      <strong className="font-extrabold text-gray-900">Legalitas gedung lengkap</strong> - IMB, PBB, &amp; izin operasional terverifikasi.
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5 sm:gap-3.5 text-[12px] sm:text-[11.5px] sm:text-[11.5px] sm:text-[14.5px] text-gray-500 font-medium leading-relaxed">
                    <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center flex-shrink-0 text-emerald-500 mt-0.5">
                    ...
                    <div>
                      <strong className="font-extrabold text-gray-900">Fasilitas pendukung</strong> - meeting room, resepsionis, WiFi, &amp; layanan surat-menyurat.
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5 sm:gap-3.5 text-[12px] sm:text-[11.5px] sm:text-[11.5px] sm:text-[14.5px] text-gray-500 font-medium leading-relaxed">
                    <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center flex-shrink-0 text-emerald-500 mt-0.5">
                    ...
                    <div>
                      <strong className="font-extrabold text-gray-900">Hemat hingga 90%</strong> - dibanding sewa kantor konvensional di area yang sama.
                    </div>
                  </li>
                </ul>
              </div>
        ...
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            >
              ...
              <p className="text-[11.5px] sm:text-[11px] sm:text-[11px] sm:text-[13.5px] text-gray-500 font-medium leading-relaxed font-sans">
      ...
      <section id="paket-harga" className="py-8 sm:py-8 sm:py-8 sm:py-20 bg-[#F9FAFB] border-b border-gray-100">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-4 sm:gap-8 items-stretch max-w-[1140px] mx-auto">
            ...
            >
              ...
              <div className="bg-[#1A1A1A] p-4 sm:p-6 text-white text-center flex-shrink-0">
                <h3 className="text-[11px] sm:text-[12.5px] font-extrabold uppercase tracking-widest text-gray-600">EASYOFFICE JAKARTA</h3>
                <div className="mt-1 sm:mt-2 text-[22px] sm:text-[22px] sm:text-[30px] font-black tracking-tight text-white">Rp3.500.000</div>
                <div className="mt-1 sm:mt-1.5 text-[8px] sm:text-[9px] font-extrabold tracking-wider text-gray-600 uppercase">PER TAHUN &middot; CILANDAK, JAKARTA SELATAN</div>
              </div>
              ...
              <div className="p-4 sm:p-7 space-y-4 sm:space-y-6 flex-grow">
                {/* Alamat Lengkap */}
                <div>
                  <h4 className="text-[8px] sm:text-[8px] sm:text-[9.5px] font-extrabold tracking-widest text-[#990202] uppercase mb-1 sm:mb-2">ALAMAT LENGKAP</h4>
                  <div className="flex items-start gap-2 text-[11.5px] sm:text-[11.5px] sm:text-[13px] font-semibold text-gray-700 leading-relaxed">
                ...
                <div className="pt-2 sm:pt-2.5 border-t border-gray-100">
                  <h4 className="text-[8px] sm:text-[8px] sm:text-[9.5px] font-extrabold tracking-widest text-[#990202] uppercase mb-1 sm:mb-2">FASILITAS OFFICE</h4>
                ...
                {/* Legalitas Gedung */}
                <div className="pt-2 sm:pt-2.5 border-t border-gray-100">
                  <h4 className="text-[8px] sm:text-[8px] sm:text-[9.5px] font-extrabold tracking-widest text-[#990202] uppercase mb-1 sm:mb-2">LEGALITAS GEDUNG</h4>
                  <ul className="space-y-1.5 sm:space-y-2">
                    <li className="flex items-start gap-2 text-[11.5px] sm:text-[11.5px] sm:text-[13px] font-semibold text-gray-700 leading-relaxed">
                      <Check className="w-3.5 h-3.5 text-emerald-500 mr-0.5 flex-shrink-0 mt-0.5" strokeWidth={3.5} />
            ...
            >
              ...
              <div className="bg-[#990202] p-4 sm:p-6 text-white text-center relative flex-shrink-0">
                ...
                <h3 className="text-[11px] sm:text-[12.5px] font-extrabold uppercase tracking-widest text-red-200 mt-2.5">EASYOFFICE BANDUNG</h3>
                <div className="mt-1 sm:mt-2 text-[22px] sm:text-[22px] sm:text-[30px] font-black tracking-tight text-white">Rp1.500.000</div>
                <div className="mt-1 sm:mt-1.5 text-[8px] sm:text-[9px] font-extrabold tracking-wider text-red-100 uppercase">PER TAHUN &middot; CIHAMPELAS, BANDUNG</div>
              </div>
              ...
              <div className="px-4 pb-4 pt-1 sm:px-7 sm:pb-7 flex-shrink-0">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full py-2.5 sm:py-3.5 bg-[#990202] hover:bg-[#800000] text-white text-center font-extrabold text-[12px] sm:text-[13.5px] rounded-xl shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200"
                >
                  Pilih Bandung
                </a>
              </div>
            ...
            >
              {/* Header Box */}
              <div className="bg-[#1A1A1A] p-4 sm:p-6 text-white text-center flex-shrink-0">
                <h3 className="text-[11px] sm:text-[12.5px] font-extrabold uppercase tracking-widest text-gray-600">EASYOFFICE BEKASI</h3>
                <div className="mt-1 sm:mt-2 text-[22px] sm:text-[22px] sm:text-[30px] font-black tracking-tight text-white">Rp2.500.000</div>
                <div className="mt-1 sm:mt-1.5 text-[8px] sm:text-[9px] font-extrabold tracking-wider text-gray-600 uppercase">PER TAHUN &middot; SUMMARECON, BEKASI</div>
              </div>
          ...
          {/* Footnote Banner */}
          <div className="max-w-[1140px] mx-auto mt-8 sm:mt-6 sm:mt-12 bg-white shadow-[0_4px_16px_rgba(0,0,0,0.06)] rounded-xl sm:rounded-2xl p-4 sm:p-5 text-[10.5px] sm:text-[12px] leading-relaxed font-medium">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.08)] z-10 aspect-[4/3]">
                ...
                <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 z-20 bg-white p-3 sm:p-4.5 rounded-xl sm:rounded-2xl shadow-[0_15px_30px_rgba(0,0,0,0.06)] max-w-[245px] flex items-center gap-2.5 sm:gap-3.5 hover:scale-105 transition-transform duration-300">
                  ...
                  <div>
                    <div className="text-[11.5px] sm:text-[13px] font-extrabold text-gray-950 leading-tight">EasyOffice Bandung</div>
                    <div className="flex items-center gap-1.5 mt-1">
                      ...
                      <span className="text-[9px] sm:text-[10px] text-gray-600 font-bold leading-none">&middot; Cihampelas</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="bg-white rounded-2xl border border-gray-150/50 shadow-[0_10px_25px_rgba(0,0,0,0.015)] p-4 sm:p-6 space-y-3 sm:space-y-4">
                ...
                <div className="space-y-1.5 sm:space-y-2 text-[11px] sm:text-[11px] sm:text-[13px] text-gray-500 font-medium font-sans">
                  <div>
                    <strong className="font-extrabold text-gray-800">No tlp:</strong> 022 3209 9037
                  </div>
                  <div>
                    <strong className="font-extrabold text-gray-800">WhatsApp:</strong> 0818 881 425 &middot; 0817 321 160
                  </div>
                  <div>
                    <strong className="font-extrabold text-gray-800">Email:</strong> id.easyoffice@gmail.com
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2.5 sm:gap-y-3">
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-2 sm:gap-2.5 text-[11.5px] sm:text-[11px] sm:text-[11px] sm:text-[13.5px] text-gray-500 font-medium leading-none">
                    ...
                    <div className="flex items-center gap-2 sm:gap-2.5 text-[11.5px] sm:text-[11px] sm:text-[11px] sm:text-[13.5px] text-gray-500 font-medium leading-none">
                      ...
                      <span>Legalitas gedung (IMB, PBB, dll)</span>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-2.5 text-[11.5px] sm:text-[11px] sm:text-[11px] sm:text-[13.5px] text-gray-500 font-medium leading-none">
                      <div className="w-4 h-4 sm:w-4.5 sm:h-4.5 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center flex-shrink-0 text-emerald-500">
                        <Check className="w-2.5 h-2.5" strokeWidth={3.5} />
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="flex items-center gap-2 sm:gap-2.5 text-[11.5px] sm:text-[11px] sm:text-[11px] sm:text-[13.5px] text-gray-500 font-medium leading-none">
                      ...
                      <span>LED Smart TV</span>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-2.5 text-[11.5px] sm:text-[11px] sm:text-[11px] sm:text-[13.5px] text-gray-500 font-medium leading-none">
                      <div className="w-4 h-4 sm:w-4.5 sm:h-4.5 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center flex-shrink-0 text-emerald-500">
                        <Check className="w-2.5 h-2.5" strokeWidth={3.5} />
                      </div>
                      <span>WiFi &amp; Internet High Speed</span>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-2.5 text-[11.5px] sm:text-[11px] sm:text-[11px] sm:text-[13.5px] text-gray-500 font-medium leading-none">
                      <div className="w-4 h-4 sm:w-4.5 sm:h-4.5 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center flex-shrink-0 text-emerald-500">
                        <Check className="w-2.5 h-2.5" strokeWidth={3.5} />
              ...
              <div className="flex flex-row gap-3 pt-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 text-center justify-center px-4 py-3 bg-[#990202] hover:bg-[#800000] text-white font-extrabold rounded-xl text-[12px] sm:text-[12px] sm:text-[14px] shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-1.5"
                >
