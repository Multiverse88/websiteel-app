    ...
    <div className="bg-white min-h-screen pt-[25px]">
      ...
      <section className="relative py-8 sm:py-8 sm:py-8 sm:py-20 overflow-hidden bg-white">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8 relative z-10">
          {/* Breadcrumbs */}
          <nav className="flex items-center gap-2 text-[11px] sm:text-[13px] text-gray-600 pt-0 pb-1 mb-1 font-medium relative -top-[50px]">
            ...
            <div className="lg:w-[50%] text-left">
              ...
              >
                <a
                  ...
                  className="flex-1 sm:flex-initial text-center justify-center px-4 sm:px-7 py-3.5 sm:py-4 bg-[#990202] hover:bg-[#800000] text-white font-extrabold rounded-xl text-[12px] sm:text-[13px] shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-1.5 sm:gap-2"
                >
        ...
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8">
          ...
          >
            <div className="max-w-2xl space-y-2 sm:space-y-3">
              <p className="text-[9px] sm:text-[11px] font-black text-[#990202] uppercase tracking-[0.2em] mb-1.5 sm:mb-3 text-left">PILIH LOKASI OFFICE</p>
              ...
              <p className="text-[12.5px] sm:text-[15px] text-gray-500 leading-relaxed mt-2 sm:mt-4 font-medium font-sans text-left">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-4 sm:gap-8 items-stretch max-w-[1140px] mx-auto">
            ...
            >
              ...
              <div className="bg-[#1A1A1A] p-4 sm:p-6 text-white text-center flex-shrink-0">
                <h3 className="text-[11px] sm:text-[12.5px] font-extrabold uppercase tracking-widest text-white">EASYOFFICE JAKARTA</h3>
                <div className="mt-1 sm:mt-2 text-[22px] sm:text-[22px] sm:text-[30px] font-black tracking-tight text-white">Rp3.500.000</div>
                <div className="mt-1 sm:mt-1.5 text-[8px] sm:text-[9px] font-extrabold tracking-wider text-white uppercase">PER TAHUN &middot; CILANDAK, JAKARTA SELATAN</div>
              </div>
            ...
            >
              ...
              <div className="bg-[#990202] p-4 sm:p-6 text-white text-center relative flex-shrink-0">
                ...
                <h3 className="text-[11px] sm:text-[12.5px] font-extrabold uppercase tracking-widest text-white mt-2.5">EASYOFFICE BANDUNG</h3>
                <div className="mt-1 sm:mt-2 text-[22px] sm:text-[22px] sm:text-[30px] font-black tracking-tight text-white">Rp1.500.000</div>
                <div className="mt-1 sm:mt-1.5 text-[8px] sm:text-[9px] font-extrabold tracking-wider text-white uppercase">PER TAHUN &middot; CIHAMPELAS, BANDUNG</div>
              </div>
            ...
            >
              {/* Header Box */}
              <div className="bg-[#1A1A1A] p-4 sm:p-6 text-white text-center flex-shrink-0">
                <h3 className="text-[11px] sm:text-[12.5px] font-extrabold uppercase tracking-widest text-white">EASYOFFICE BEKASI</h3>
                <div className="mt-1 sm:mt-2 text-[22px] sm:text-[22px] sm:text-[30px] font-black tracking-tight text-white">Rp2.500.000</div>
                <div className="mt-1 sm:mt-1.5 text-[8px] sm:text-[9px] font-extrabold tracking-wider text-white uppercase">PER TAHUN &middot; SUMMARECON, BEKASI</div>
              </div>
