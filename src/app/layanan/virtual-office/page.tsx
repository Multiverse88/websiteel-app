            ...
            >
              <div className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.08)] h-full w-full">
                ...
                <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 z-20 bg-white p-3 sm:p-4.5 rounded-xl sm:rounded-2xl shadow-[0_15px_30px_rgba(0,0,0,0.06)] max-w-[280px] flex items-center gap-2.5 sm:gap-3.5 hover:scale-105 transition-transform duration-300">
                  ...
                  <div>
                    <div className="text-[16px] sm:text-[16px] font-extrabold text-gray-950 leading-tight">3 Lokasi Strategis</div>
                    <div className="text-[16px] sm:text-[16px] text-gray-600 font-medium leading-tight mt-1">Cihampelas Bandung - Cilandak Jakarta - Summarecon Bekasi</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8">
          ...
          >
            <div className="max-w-2xl space-y-2 sm:space-y-3">
              <p className="text-[16px] sm:text-[16px] font-black text-[#990202] uppercase tracking-[0.2em] mb-1.5 sm:mb-3 text-left">PILIH LOKASI OFFICE</p>
              <h2 className="font-heading text-[16px] sm:text-[38px] font-black text-gray-950 leading-[1.25] sm:leading-tight tracking-tight text-left">
                3 lokasi EasyOffice, pilih yang paling strategis.
              </h2>
              <p className="text-[16px] sm:text-[16px] text-gray-500 leading-relaxed mt-2 sm:mt-4 font-medium font-sans text-left">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-4 sm:gap-8 items-stretch max-w-[1140px] mx-auto">
            ...
            >
              ...
              <div className="bg-[#1A1A1A] p-4 sm:p-6 text-white text-center flex-shrink-0">
                <h3 className="text-[16px] sm:text-[16px] font-extrabold uppercase tracking-widest text-white">EASYOFFICE JAKARTA</h3>
                <div className="mt-1 sm:mt-2 text-[16px] sm:text-[16px] sm:text-[30px] font-black tracking-tight text-white">Rp3.500.000</div>
                <div className="mt-1 sm:mt-1.5 text-[16px] sm:text-[16px] font-extrabold tracking-wider text-white uppercase">PER TAHUN &middot; CILANDAK, JAKARTA SELATAN</div>
              </div>
              ...
              <div className="p-4 sm:p-7 space-y-4 sm:space-y-6 flex-grow">
                {/* Alamat Lengkap */}
                <div>
                  <h4 className="text-[16px] sm:text-[16px] sm:text-[16px] font-extrabold tracking-widest text-[#990202] uppercase mb-1 sm:mb-2">ALAMAT LENGKAP</h4>
                  <div className="flex items-start gap-2 text-[16px] sm:text-[16px] sm:text-[16px] font-semibold text-gray-700 leading-relaxed">
                ...
                <div className="pt-2 sm:pt-2.5 border-t border-gray-100">
                  <h4 className="text-[16px] sm:text-[16px] sm:text-[16px] font-extrabold tracking-widest text-[#990202] uppercase mb-1 sm:mb-2">FASILITAS OFFICE</h4>
                  <ul className="space-y-1.5 sm:space-y-2">
                    <li className="flex items-start gap-2 text-[16px] sm:text-[16px] sm:text-[16px] font-semibold text-gray-700 leading-relaxed">
                      <Check className="w-3.5 h-3.5 text-emerald-500 mr-0.5 flex-shrink-0 mt-0.5" strokeWidth={3.5} />
                ...
                {/* Legalitas Gedung */}
                <div className="pt-2 sm:pt-2.5 border-t border-gray-100">
                  <h4 className="text-[16px] sm:text-[16px] sm:text-[16px] font-extrabold tracking-widest text-[#990202] uppercase mb-1 sm:mb-2">LEGALITAS GEDUNG</h4>
                  <ul className="space-y-1.5 sm:space-y-2">
                    <li className="flex items-start gap-2 text-[16px] sm:text-[16px] sm:text-[16px] font-semibold text-gray-700 leading-relaxed">
                      <Check className="w-3.5 h-3.5 text-emerald-500 mr-0.5 flex-shrink-0 mt-0.5" strokeWidth={3.5} />
                ...
                <div className="pt-2 sm:pt-2.5 border-t border-gray-100">
                  <div className="bg-gray-50 shadow-md border border-black/[0.03] rounded-2xl p-3 sm:p-4 space-y-1.5 sm:space-y-2">
                    <h4 className="text-[16px] sm:text-[16px] sm:text-[16px] font-extrabold tracking-widest text-[#990202] uppercase mb-0.5 sm:mb-1">AKSES TRANSPORTASI</h4>
                    <ul className="space-y-1.5 sm:space-y-2">
                      <li className="flex items-start gap-2 text-[16px] sm:text-[16px] sm:text-[16px] font-semibold text-gray-700 leading-relaxed">
                        <Check className="w-3.5 h-3.5 text-emerald-500 mr-0.5 flex-shrink-0 mt-0.5" strokeWidth={3.5} />
              ...
              <div className="px-4 pb-4 pt-1 sm:px-7 sm:pb-7 flex-shrink-0">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full py-2.5 sm:py-3.5 bg-white shadow-md border border-black/[0.04] text-gray-800 hover:bg-gray-50 hover:border-gray-300 text-center font-extrabold text-[16px] sm:text-[16px] rounded-xl shadow-sm hover:shadow hover:-translate-y-0.5 transition-all duration-200"
                >
                  Pilih Jakarta
                </a>
              </div>
            ...
            >
              ...
              <div className="bg-[#990202] p-4 sm:p-6 text-white text-center relative flex-shrink-0">
                <div className="absolute top-2.5 left-0 right-0 text-[16px] font-black uppercase tracking-wider text-white bg-red-800/80 py-0.5 w-[110px] mx-auto rounded-full">
                  PALING POPULER
                </div>
                <h3 className="text-[16px] sm:text-[16px] font-extrabold uppercase tracking-widest text-white mt-2.5">EASYOFFICE BANDUNG</h3>
                <div className="mt-1 sm:mt-2 text-[16px] sm:text-[16px] sm:text-[30px] font-black tracking-tight text-white">Rp1.500.000</div>
                <div className="mt-1 sm:mt-1.5 text-[16px] sm:text-[16px] font-extrabold tracking-wider text-white uppercase">PER TAHUN &middot; CIHAMPELAS, BANDUNG</div>
              </div>
              ...
              <div className="px-4 pb-4 pt-1 sm:px-7 sm:pb-7 flex-shrink-0">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full py-2.5 sm:py-3.5 bg-[#990202] hover:bg-[#800000] text-white text-center font-extrabold text-[16px] sm:text-[16px] rounded-xl shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200"
                >
                  Pilih Bandung
                </a>
              </div>
            ...
            >
              {/* Header Box */}
              <div className="bg-[#1A1A1A] p-4 sm:p-6 text-white text-center flex-shrink-0">
                <h3 className="text-[16px] sm:text-[16px] font-extrabold uppercase tracking-widest text-white">EASYOFFICE BEKASI</h3>
                <div className="mt-1 sm:mt-2 text-[16px] sm:text-[16px] sm:text-[30px] font-black tracking-tight text-white">Rp2.500.000</div>
                <div className="mt-1 sm:mt-1.5 text-[16px] sm:text-[16px] font-extrabold tracking-wider text-white uppercase">PER TAHUN &middot; SUMMARECON, BEKASI</div>
              </div>
          ...
          {/* Footnote Banner */}
          <div className="max-w-[1140px] mx-auto mt-8 sm:mt-6 sm:mt-12 bg-white shadow-[0_4px_16px_rgba(0,0,0,0.06)] rounded-xl sm:rounded-2xl p-4 sm:p-5 text-[16px] sm:text-[16px] leading-relaxed font-medium">
                  ...
                  <div className="lg:col-span-6 relative">
                    <div className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.08)] z-10 aspect-[4/3]">
                      ...
                      <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 z-20 bg-white p-3 sm:p-4.5 rounded-xl sm:rounded-2xl shadow-[0_15px_30px_rgba(0,0,0,0.06)] max-w-[245px] flex items-center gap-2.5 sm:gap-3.5 hover:scale-105 transition-transform duration-300">
                        ...
                        <div>
                          <div className="text-[16px] sm:text-[16px] font-extrabold text-gray-950 leading-tight">{loc.cardTitle}</div>
                          <div className="flex items-center gap-1.5 mt-1">
                            ...
                            <span className="text-[16px] sm:text-[16px] text-gray-600 font-bold leading-none">&middot; {loc.cardSubtitle}</span>
                          </div>
                        </div>
                      </div>
                    </div>
