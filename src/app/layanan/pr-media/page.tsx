...
export default function PRMedia() {
  ...
  return (
    <div className="has-service-cta flex flex-col min-h-screen bg-[#FCFBFA] text-gray-900 font-sans">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8 border-t border-gray-150 max-w-[620px]">
                ...
                <div className="flex items-center space-x-3 bg-gray-50/50 p-2.5 rounded-xl shadow-[0_4px_16px_rgba(0,0,0,0.06)]">
                  ...
                  <div>
                    <div className="text-[13.5px] font-black text-gray-950">1–3 Hari</div>
                ...
                <div className="flex items-center space-x-3 bg-gray-50/50 p-2.5 rounded-xl shadow-[0_4px_16px_rgba(0,0,0,0.06)]">
                  ...
                  <div>
                    <div className="text-[13.5px] font-black text-gray-950">100+ Media</div>
                ...
                <div className="flex items-center space-x-3 bg-gray-50/50 p-2.5 rounded-xl shadow-[0_4px_16px_rgba(0,0,0,0.06)]">
                  ...
                  <div>
                    <div className="text-[13.5px] font-black text-gray-950">100% Garansi</div>
      ...
      <section className="bg-[#FCFBFA] py-8 sm:py-8 sm:py-20">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8 text-center">
          ...
          <div className="relative max-w-[1240px] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 relative z-10">
              ...
              <div className="relative flex flex-col group">
                {/* Number Badge */}
                <div className="w-8.5 h-8.5 sm:w-10 sm:h-10 rounded-full border-2 border-[#990202] text-[#990202] bg-white flex items-center justify-center font-bold text-[14px] ml-0 relative z-10 shadow-sm transition-transform duration-300 group-hover:scale-110">
                  01
                </div>
                {/* Gap 20px */}
