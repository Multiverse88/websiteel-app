    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto bg-gray-100 p-8 relative">
        <div className="max-w-[1280px] mx-auto shadow-2xl rounded-2xl overflow-hidden bg-white min-h-[800px]">
          {isPending && <div className="absolute top-4 right-4 bg-white px-3 py-1 rounded shadow text-xs font-bold text-gray-500">Menyimpan...</div>}
      ...
      <div className="w-80 bg-white border-l border-gray-200 p-4 flex flex-col overflow-y-auto shadow-xl z-30">
        ...
        {activeSection ? (
          ...
          <form action={async (formData) => {
            ...
            <div>
              <label className="block text-xs font-bold text-gray-700 mb-1">Pixel ID (Meta/GTM)</label>
              <input type="text" name="pixelId" defaultValue={pageSettings.pixelId} className="w-full text-sm px-3 py-2 border rounded" />
            </div>
            
            <div className="border-t pt-4 space-y-3">
              <h3 className="text-xs font-bold text-gray-900">Pengaturan Redirect Lead</h3>
              ...
              {redirectEnabled && (
                <div className="space-y-3 pl-5 border-l-2 border-gray-100">
                  <div>
                    <label className="block text-xs font-bold text-gray-600 mb-1">Redirect URL (WhatsApp / Thank You Page)</label>
                    <input
                      type="text"
                      name="redirectUrl"
                      value={redirectUrl}
                  ...
                  <div>
                    <label className="block text-xs font-bold text-gray-600 mb-1">Delay Redirect (Detik)</label>
                    <input
                      type="number"
                      name="redirectDelay"
                      value={redirectDelay}
