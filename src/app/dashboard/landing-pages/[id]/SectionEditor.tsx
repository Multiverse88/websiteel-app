  ...
  const renderImageUpload = (
    ...
    return (
      <div className="space-y-2 border-t border-gray-100 pt-3 mt-3">
        <label className="block text-[16px] font-bold text-gray-700">{label}</label>
        {imageUrl && (
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-grow text-[16px] px-2.5 py-1.5 border rounded focus:ring-1 focus:ring-red-500 focus:outline-none"
          />
          <label className="flex items-center justify-center px-3 py-1.5 bg-gray-100 hover:bg-gray-200 border rounded cursor-pointer transition-colors text-[16px] font-medium text-gray-700">
            {isUploading ? (
        ...
        <input
          ...
          className="w-full text-[16px] px-2.5 py-1.5 border rounded focus:ring-1 focus:ring-red-500 focus:outline-none"
        />
      </div>
    );
  };
  ...
  switch (section.type) {
    case "hero":
      return (
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-[16px] font-bold text-gray-700 mb-1">Subheadline</label>
            <textarea
              value={section.subheadline || ""}
              onChange={(e) => handleTextChange("subheadline", e.target.value)}
              className="w-full text-[16px] px-3 py-2 border rounded h-16"
            />
          </div>
          <div>
            <label className="block text-[16px] font-bold text-gray-700 mb-1">CTA Text</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-[16px] font-bold text-gray-700 mb-1">CTA Link</label>
            <input
              type="text"
    ...
    case "banner":
      return (
        <div className="space-y-4">
          <div>
            <label className="block text-[16px] font-bold text-gray-700 mb-1">Link Banner (Opsional)</label>
            <input
              type="text"
              value={section.link || ""}
    ...
    case "features":
      return (
        <div className="space-y-4">
          <div>
            <label className="block text-[16px] font-bold text-gray-700 mb-1">Judul Section</label>
            <input
              type="text"
              value={section.title || ""}
          ...
          <div className="space-y-3 pt-3 border-t">
            <div className="flex justify-between items-center">
              <label className="block text-[16px] font-bold text-gray-700">Daftar Fitur</label>
              <button
                type="button"
                onClick={() => addItem({ title: "Fitur Baru", desc: "Deskripsi fitur baru..." })}
                className="inline-flex items-center gap-1 text-[16px] font-bold text-red-600 hover:text-red-700"
              >
              ...
              <div key={idx} className="p-3 bg-gray-50 border rounded-lg space-y-2 relative group/item">
                ...
                <div>
                  <input
                    ...
                    className="w-full text-[16px] px-2.5 py-1.5 border rounded"
                  />
                </div>
                <div>
                  <textarea
                    ...
                    className="w-full text-[16px] px-2.5 py-1.5 border rounded h-16"
                  />
                </div>
                {renderImageUpload(
    ...
    case "testimonials":
      return (
        <div className="space-y-4">
          ...
          <div className="space-y-3 pt-3 border-t">
            <div className="flex justify-between items-center">
              <label className="block text-[16px] font-bold text-gray-700">Daftar Testimoni</label>
              <button
                type="button"
    ...
    case "leadForm":
      return (
        <div className="space-y-4">
          <div>
            <label className="block text-[16px] font-bold text-gray-700 mb-1">Judul Form</label>
            <input
              type="text"
              value={section.title || ""}
              onChange={(e) => handleTextChange("title", e.target.value)}
          ...
          <div>
            <label className="block text-[16px] font-bold text-gray-700 mb-1">Sub-judul Form</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-[16px] font-bold text-gray-700 mb-1">Teks Tombol Kirim</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-[16px] font-bold text-gray-700 mb-1.5">Fields yang Wajib Diisi</label>
            <div className="space-y-2 border p-3 rounded bg-gray-50">
              {([
                ...
                return (
                  <label key={key} className="flex items-center gap-2 text-[16px] font-medium text-gray-700">
                    <input
                      type="checkbox"
                      checked={isChecked}
    ...
    case "richText":
      return (
        <div className="space-y-4">
          <div>
            <label className="block text-[16px] font-bold text-gray-700 mb-1">Editor Kode HTML / Markdown</label>
            <textarea
              value={section.html || ""}
              onChange={(e) => handleTextChange("html", e.target.value)}
              placeholder="Masukkan tag HTML atau teks biasa di sini..."
              className="w-full font-mono text-[16px] p-3 border rounded h-64 focus:outline-none focus:ring-1 focus:ring-red-500"
            />
          </div>
        </div>
      );
