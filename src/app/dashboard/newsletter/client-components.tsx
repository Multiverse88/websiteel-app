  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[16px] font-bold bg-[#990202] text-white hover:bg-[#800000] border border-[#990202] transition-all shadow-sm"
      >
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50/70">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 text-[16px]">Atur Template Newsletter</h3>
                  <p className="text-[16px] text-gray-500">Sesuaikan subjek dan isi pesan sebelum dikirim</p>
                </div>
              </div>
              <button 
            ...
            <form onSubmit={handleBroadcast} className="p-6 flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[16px] font-bold text-gray-700">Subjek Email</label>
                <input 
                  type="text"
                  value={subject}
              ...
              {/* Message Input */}
              <div className="flex flex-col gap-1.5">
                <label className="text-[16px] font-bold text-gray-700">Pesan Pengantar (Greeting)</label>
                <textarea 
                  value={customText}
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[16px] font-bold text-gray-500 uppercase tracking-wider">Live Preview Tampilan Email</label>
                <div className="shadow-md border border-black/[0.04] rounded-lg overflow-hidden bg-gray-50">
                  <div className="bg-white px-4 py-2 border-b border-gray-200 text-[16px] text-gray-400 flex items-center gap-1.5">
                    <span className="font-semibold text-gray-600">Subjek:</span> {subject || <span className="italic text-gray-300">Kosong</span>}
                  </div>
                  <div className="p-5 font-sans text-[16px] text-gray-800 bg-white m-3 rounded shadow-sm shadow-md border border-black/[0.03] max-h-[180px] overflow-y-auto">
                    <div className="mb-4 text-[#990202] font-bold text-[16px] border-b border-red-100 pb-2">Easy Legal</div>
                    <p className="whitespace-pre-wrap text-gray-600 leading-relaxed mb-4 text-[16px]">
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 shadow-sm border border-black/[0.02] flex flex-col gap-1">
                      <div className="text-[16px] uppercase font-bold text-[#990202]">{`Kategori: ${articleTitle ? 'Legalitas' : ''}`}</div>
                      <div className="font-bold text-gray-900 text-[16px]">{articleTitle}</div>
                      <div className="text-[16px] text-gray-400 mt-1">✓ Klik di email untuk membaca selengkapnya</div>
                    </div>
                    <div className="mt-5 pt-3 border-t border-gray-100 text-[16px] text-center text-gray-400">
              ...
              {/* Feedback messages */}
              {status === "success" && (
                <div className="p-3 bg-emerald-50 text-emerald-700 rounded-lg text-[16px] font-semibold flex items-center gap-2 border border-emerald-100">
                  <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" />
                  {message}
                </div>
              )}
              {status === "error" && (
                <div className="p-3 bg-red-50 text-red-700 rounded-lg text-[16px] font-semibold flex items-center gap-2 border border-red-100">
              ...
              <div className="flex items-center justify-end gap-2 border-t border-gray-100 pt-4 mt-1">
                <button
                  ...
                  className="px-4 py-2 text-[16px] font-bold text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-all"
                >
                  Batal
                </button>
                <button
                  type="submit"
                  disabled={status === "loading" || status === "success"}
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-[16px] font-bold bg-[#990202] text-white hover:bg-[#800000] border border-[#990202] transition-all disabled:opacity-50"
                >
                  {status === "loading" ? (
                    <>
