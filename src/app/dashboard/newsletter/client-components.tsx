  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-bold bg-[#990202] text-white hover:bg-[#800000] border border-[#990202] transition-all shadow-sm"
      >
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50/70">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-gray-500">Sesuaikan subjek dan isi pesan sebelum dikirim</p>
                </div>
              </div>
              <button 
            ...
            <form onSubmit={handleBroadcast} className="p-6 flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-700">Subjek Email</label>
                <input 
                  type="text"
                  value={subject}
              ...
              {/* Message Input */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-700">Pesan Pengantar (Greeting)</label>
                <textarea 
                  value={customText}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="shadow-md border border-black/[0.04] rounded-lg overflow-hidden bg-gray-50">
                  ...
                  <div className="p-5 font-sans text-sm text-gray-800 bg-white m-3 rounded shadow-sm shadow-md border border-black/[0.03] max-h-[180px] overflow-y-auto">
                    ...
                    <div className="mt-5 pt-3 border-t border-gray-100 text-[10px] text-center text-gray-400">
              ...
              <div className="flex items-center justify-end gap-2 border-t border-gray-100 pt-4 mt-1">
                ...
                <button
                  type="submit"
                  disabled={status === "loading" || status === "success"}
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-bold bg-[#990202] text-white hover:bg-[#800000] border border-[#990202] transition-all disabled:opacity-50"
                >
                  {status === "loading" ? (
                    <>
