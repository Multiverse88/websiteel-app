    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 shadow-sm flex flex-col gap-4">
      ...
      <form onSubmit={handleTest} className="flex flex-col gap-3">
        <div className="flex flex-col gap-1.5">
          <label className="text-[16px] font-bold text-gray-700">Email Penerima</label>
          <input
            type="email"
            value={testEmail}
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg text-[16px] font-bold bg-white text-gray-700 hover:text-gray-900 shadow-sm border border-gray-200 hover:bg-gray-50 shadow-sm transition-all disabled:opacity-50"
        >
          {status === "loading" ? (
            <>
  ...
  return (
    <form onSubmit={handleSave} className="flex flex-col gap-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 shadow-sm flex flex-col gap-4">
        ...
        {/* Info Box */}
        <div className={`p-4 rounded-lg text-[16px] flex gap-3 border ${
          autoBroadcast 
      ...
      <div className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 shadow-sm flex flex-col gap-5 transition-opacity duration-300 ${
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center justify-between">
            <label className="text-[16px] font-bold text-gray-700">Subjek Default</label>
            <span className="text-[16px] text-gray-400 font-semibold flex items-center gap-1">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center justify-between">
            <label className="text-[16px] font-bold text-gray-700">Pesan Pengantar Default (Greeting)</label>
            <span className="text-[16px] text-gray-400 font-semibold flex items-center gap-1">
        ...
        {/* Preview Live */}
        <div className="flex flex-col gap-1.5">
          <div className="text-[16px] font-bold text-gray-500 uppercase tracking-wider flex items-center gap-1">
            <RefreshCw className="w-3.5 h-3.5" /> Preview Hasil Auto-Broadcast
          </div>
          <div className="shadow-sm border border-gray-200 rounded-lg overflow-hidden bg-gray-50 text-[16px]">
            ...
            <div className="p-4 bg-white m-3 rounded shadow-sm border border-gray-200 max-h-[160px] overflow-y-auto">
              <div className="mb-3 text-[#990202] font-bold text-[16px] pb-1.5 border-b border-red-50">Easy Legal</div>
              ...
              <div className="bg-gray-50 rounded-lg p-2.5 shadow-sm border border-black/[0.02] flex flex-col gap-0.5">
                <div className="text-[16px] uppercase font-bold text-[#990202]">{sampleArticleCategory}</div>
                <div className="font-bold text-gray-900 text-[16px]">{sampleArticleTitle}</div>
      ...
      <div className="flex items-center justify-between border-t border-gray-100 pt-4 mt-1">
        <Link
          ...
          className="inline-flex items-center gap-1 px-4 py-2 rounded-lg text-[16px] font-bold text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-all"
        >
